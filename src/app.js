...
app.get("/user",async (req,res) => {
    try{
        ...
        res.status(400).send("SOmething went wrong searching for a user ",err.message);
    }
})
...
app.patch("/user/:userId", async (req, res) => {
    ...
    try {
        ...
        const isAllowedUpdates = Object.keys(req.body).every((k) => ALLOWED_UPDATES.includes(k));
